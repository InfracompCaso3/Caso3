...
public class Servidor {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("DEBUG → Servidor: llave privada cargada correctamente.");  // DEBUG
            initializeServices();

            ServerSocket serverSocket = new ServerSocket(12345);
            System.out.println("Servidor principal iniciado en puerto 12345...");
            System.out.println("DEBUG → Servidor: escuchando en el puerto " 
                               + serverSocket.getLocalPort());  // DEBUG
    ...
    private static void handleClient(Socket socket) {
        try (
            ...
            byte[] datosCifrados = Simetrico.cifrar(datosServicios, claveAES, iv);
            byte[] firma = Asimetrico.firmar(datosCifrados, privateKey);
