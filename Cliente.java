...
public class Cliente {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("DEBUG → Cliente: llave pública cargada correctamente.");
            ...
            if (!Asimetrico.verificar(datosCifrados, firma, serverPublicKey)) {
            ...
            byte[] datosDescifrados = Simetrico.descifrar(datosCifrados, claveAES, iv);
